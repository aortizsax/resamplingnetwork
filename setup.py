...
project_init = _read(["src", "resamplingnetwork", "__init__.py"])
...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "resamplingnetwork = resamplingnetwork.application.resamplingnetwork:main",
        ]
    },
    ...
    package_data={
        ...
        "resamplingnetwork": [
            ...
            # For files located in 'src/resamplingnetwork-data/'
            # "../resamplingnetwork-data/*.json",
            # For files located in 'resources'/'
            # "../../resources/*.json",
        ],
    },
    test_suite = "tests",
    # url="http://pypi.python.org/pypi/resamplingnetwork",
    url="https://github.com/jeetsukumaran/resamplingnetwork",
    license="LICENSE",
